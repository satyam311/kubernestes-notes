...
Now under this file we haave the certificate that is issue under the parameter : "certificate", we need to decode it to base64 and paste it under ca.key so that it can be used later
